...
ns_figure_absent_stimuli = [88;1];
ns_figure_present_stimuli = [176;1];
...
stimulus = generate_one_stimulus(chord_duration, 10*stimulus_duration, 9, 20, true, false, sample_rate, all_freqs, sound_level);
...
figure_duration_example = 10; % easy
% 3 background only
example_bg_names = [];
for i = 1:3
